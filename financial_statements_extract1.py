...
acc=get_filtered_filings(ticker,ten_k=True,just_accession_numbers=True)  #get accession number

acc_num = acc.iloc[0].replace("-", "")#to change the year we can use .iloc[1] for 1 yer back
# print(acc_num)
...
# print(get_statement_file_names_in_filing_summary(ticker,acc_num))
soup=get_statement_soup(ticker,acc_num,"balance_sheet",headers=headers,statement_keys_map=statement_keys_map) #this gets us the html file